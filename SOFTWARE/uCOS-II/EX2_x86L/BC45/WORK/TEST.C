...
/*
normal display from Q and P
*/
static  void  TaskStartDisp_norm (void)
{
    char   s[80];
...
{
    // OS_ENTER_CRITICAL();
    // OSTCBCur->compTime = TASK_1_C;
    // OSTCBCur->period = TASK_1_P;
    // OS_EXIT_CRITICAL();
